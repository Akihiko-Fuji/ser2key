...
## 主な機能
- 🔧 **シリアル通信の柔軟な設定** – `タスクトレイ` と `config.ini` でボーレート、パリティ、タイムアウトなどを調整可能  
...
特に 日本語・中国語・韓国語 の QR コード入力時には、[某有名企業のソフトウェア](https://www.keyence.co.jp/support/codereader/blsrus/soft/#d12)比べ数倍高速です。
