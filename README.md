...
The specific performance comparison target is Keyence's AutoID Keyboard Wedge, which operates about 10 times faster in conversion than the AutoID Keyboard Wedge.
